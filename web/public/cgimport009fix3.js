// CGIMPORT009 FIX3 · multi-session compatible Firebase + hard cache bust
...
function relabelUi(){
  ...
  if(kicker)kicker.textContent='CGIMPORT009 FIX3 · FIREBASE MULTI-SESSION · 1:1';
  if(sub)sub.textContent=
    'Collez l’URL d’un thème Quizypedia : les questionnaires sont capturés en lot avec reprise automatique dans des sessions compatibles Firebase. Aucun contenu QCM n’est inventé.';
