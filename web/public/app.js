...
async function cgweb018QueryThemeContains(options = {}) {
  ...
  const response = await fetch(
    "https://europe-west1-culturegeneralesync.cloudfunctions.net/cgweb018ThemeContains",
    {
      method: "POST",
      headers: {
